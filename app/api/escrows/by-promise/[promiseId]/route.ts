...
/**
 * GET /api/escrows/by-promise/[promiseId]
...
export async function GET(request: NextRequest, context: RouteContext) {
  try {
    ...
    // Get escrow by promise ID
    const escrow = await convexClient.query(api.escrow.queries.getEscrowByPromise, {
    ...
    console.error("Get escrow by promise error:", error);
