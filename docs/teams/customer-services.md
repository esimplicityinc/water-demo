...
sidebar_label: "Customer Services"
---
...
<div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderLeft: '4px solid #3b82f6', borderRadius: '8px', padding: '24px', marginBottom: '24px' }}>
  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', flexWrap: 'wrap', gap: '12px' }}>
    <div>
      <h2 style={{ margin: '0 0 8px 0', color: '#0f172a', fontSize: '24px' }}>Customer Services</h2>
  ...
  <div style={{ marginTop: '12px', display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
    <span style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#f1f5f9', color: '#475569', border: '1px solid #cbd5e1' }}>Bounded Context: Customer Account Management</span>
  </div>
</div>
...
<div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderLeft: '4px solid #3b82f6', borderRadius: '8px', padding: '24px', marginBottom: '24px' }}>
  ...
  <div style={{ marginBottom: '20px' }}>
    ...
    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
      <span style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#f1f5f9', color: '#475569', border: '1px solid #cbd5e1' }}>CustomerAccount</span>
      <span style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#f1f5f9', color: '#475569', border: '1px solid #cbd5e1' }}>AccountStatus</span>
      <span style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#f1f5f9', color: '#475569', border: '1px solid #cbd5e1' }}>ServiceDeposit</span>
    </div>
  </div>
  ...
  <div style={{ marginBottom: '20px' }}>
    ...
    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
      <span style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#f1f5f9', color: '#475569', border: '1px solid #cbd5e1' }}>AccountCreated</span>
      <span style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#f1f5f9', color: '#475569', border: '1px solid #cbd5e1' }}>StatusChanged</span>
      <span style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#f1f5f9', color: '#475569', border: '1px solid #cbd5e1' }}>DepositReleased</span>
    </div>
  </div>
  ...
  <div style={{ marginBottom: '20px' }}>
    ...
    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
      <a href="/docs/capabilities/CAP-001" style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#dbeafe', color: '#1e40af', textDecoration: 'none', border: '1px solid #93c5fd' }}>CAP-001 Portal Auth</a>
      <a href="/docs/capabilities/CAP-005" style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#dbeafe', color: '#1e40af', textDecoration: 'none', border: '1px solid #93c5fd' }}>CAP-005 Self-Service Portal</a>
    </div>
  </div>
  ...
  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px' }}>
    ...
    <tbody>
      <tr>
        ...
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#0f172a', fontWeight: '600' }}>85</td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#64748b' }}>Sarah Chen</td>
      </tr>
      <tr>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#0f172a' }}>PA-002 BDD & Test</td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0' }}><span style={{ display: 'inline-block', padding: '2px 10px', borderRadius: '9999px', fontSize: '11px', fontWeight: '600', backgroundColor: '#dcfce7', color: '#166534' }}>Proficient</span></td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#0f172a', fontWeight: '600' }}>80</td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#64748b' }}>James Kowalski</td>
      </tr>
      <tr>
        ...
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#0f172a', fontWeight: '600' }}>62</td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#64748b' }}>Marcus Rivera</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#0f172a', fontWeight: '600' }}>92</td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#64748b' }}>Aisha Patel</td>
      </tr>
      <tr>
        <td style={{ padding: '10px 16px', color: '#0f172a' }}>PA-006 Data Eng</td>
        <td style={{ padding: '10px 16px' }}><span style={{ display: 'inline-block', padding: '2px 10px', borderRadius: '9999px', fontSize: '11px', fontWeight: '600', backgroundColor: '#fef3c7', color: '#92400e' }}>Exploring</span></td>
        <td style={{ padding: '10px 16px', color: '#0f172a', fontWeight: '600' }}>35</td>
        <td style={{ padding: '10px 16px', color: '#64748b' }}>Marcus Rivera</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div style={{ background: '#ffffff', border: '1px solid #e2e8f0', borderRadius: '8px', overflow: 'auto', marginBottom: '24px' }}>
  <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', minWidth: '700px' }}>
    ...
    <tbody>
      <tr>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#0f172a', fontWeight: '500' }}>Sarah Chen</td>
      ...
      <tr>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#0f172a', fontWeight: '500' }}>Marcus Rivera</td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}><span style={{ display: 'inline-block', padding: '2px 10px', borderRadius: '9999px', fontSize: '11px', fontWeight: '600', backgroundColor: '#dbeafe', color: '#1e40af' }}>Practitioner</span></td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}><span style={{ display: 'inline-block', padding: '2px 10px', borderRadius: '9999px', fontSize: '11px', fontWeight: '600', backgroundColor: '#dbeafe', color: '#1e40af' }}>Practitioner</span></td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}><span style={{ display: 'inline-block', padding: '2px 10px', borderRadius: '9999px', fontSize: '11px', fontWeight: '600', backgroundColor: '#dcfce7', color: '#166534' }}>Expert</span></td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}><span style={{ display: 'inline-block', padding: '2px 10px', borderRadius: '9999px', fontSize: '11px', fontWeight: '600', backgroundColor: '#dbeafe', color: '#1e40af' }}>Practitioner</span></td>
      ...
      <tr>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', color: '#0f172a', fontWeight: '500' }}>Aisha Patel</td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}><span style={{ display: 'inline-block', padding: '2px 10px', borderRadius: '9999px', fontSize: '11px', fontWeight: '600', backgroundColor: '#fef3c7', color: '#92400e' }}>Working</span></td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}><span style={{ display: 'inline-block', padding: '2px 10px', borderRadius: '9999px', fontSize: '11px', fontWeight: '600', backgroundColor: '#dbeafe', color: '#1e40af' }}>Practitioner</span></td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}><span style={{ display: 'inline-block', padding: '2px 10px', borderRadius: '9999px', fontSize: '11px', fontWeight: '600', backgroundColor: '#fef3c7', color: '#92400e' }}>Working</span></td>
        <td style={{ padding: '10px 16px', borderBottom: '1px solid #e2e8f0', textAlign: 'center' }}><span style={{ display: 'inline-block', padding: '2px 10px', borderRadius: '9999px', fontSize: '11px', fontWeight: '600', backgroundColor: '#f1f5f9', color: '#64748b' }}>Awareness</span></td>
      ...
      <tr>
        <td style={{ padding: '10px 16px', color: '#0f172a', fontWeight: '500' }}>James Kowalski</td>
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: '16px', marginBottom: '24px' }}>
  ...
  <div style={{ background: '#ffffff', border: '1px solid #e2e8f0', borderLeft: '4px solid #3b82f6', borderRadius: '8px', padding: '20px' }}>
    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
      ...
      <span style={{ color: '#0f172a', fontSize: '13px', fontWeight: '600' }}>~35</span>
    </div>
    <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '8px' }}>
    ...
    <div style={{ marginBottom: '4px', display: 'flex', justifyContent: 'space-between' }}>
      ...
      <span style={{ color: '#0f172a', fontSize: '13px', fontWeight: '600' }}>85%</span>
    </div>
  ...
  <div style={{ background: '#ffffff', border: '1px solid #e2e8f0', borderLeft: '4px solid #3b82f6', borderRadius: '8px', padding: '20px' }}>
    ...
    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
      ...
      <span style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#f1f5f9', color: '#475569', border: '1px solid #cbd5e1' }}>ADR-003 Clerk Auth</span>
      <span style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#f1f5f9', color: '#475569', border: '1px solid #cbd5e1' }}>ADR-010 Account Domain Model</span>
    </div>
  </div>
  ...
  <div style={{ background: '#ffffff', border: '1px solid #e2e8f0', borderLeft: '4px solid #3b82f6', borderRadius: '8px', padding: '20px' }}>
    ...
    <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap' }}>
      <span style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#dcfce7', color: '#166534', border: '1px solid #86efac' }}>NFR-SEC-001 Security (Primary)</span>
      <span style={{ display: 'inline-block', padding: '4px 12px', borderRadius: '9999px', fontSize: '12px', fontWeight: '500', backgroundColor: '#dcfce7', color: '#166534', border: '1px solid #86efac' }}>NFR-A11Y-001 Accessibility (Primary)</span>
    </div>
  </div>
...
<div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', marginBottom: '24px' }}>
  <a href="/docs/user-stories/US-001" style={{ display: 'inline-block', padding: '6px 14px', borderRadius: '9999px', fontSize: '13px', fontWeight: '500', backgroundColor: '#f8fafc', color: '#0f172a', textDecoration: 'none', border: '1px solid #e2e8f0' }}>US-001 Customer Enrollment</a>
  <a href="/docs/user-stories/US-002" style={{ display: 'inline-block', padding: '6px 14px', borderRadius: '9999px', fontSize: '13px', fontWeight: '500', backgroundColor: '#f8fafc', color: '#0f172a', textDecoration: 'none', border: '1px solid #e2e8f0' }}>US-002 Account Activation</a>
  <a href="/docs/user-stories/US-005" style={{ display: 'inline-block', padding: '6px 14px', borderRadius: '9999px', fontSize: '13px', fontWeight: '500', backgroundColor: '#f8fafc', color: '#0f172a', textDecoration: 'none', border: '1px solid #e2e8f0' }}>US-005 Account Dashboard</a>
</div>
...
<div style={{ background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: '8px', padding: '16px', display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
  <a href="/docs/systems/customer-account-mgmt" style={{ display: 'inline-block', padding: '6px 14px', borderRadius: '9999px', fontSize: '13px', fontWeight: '500', backgroundColor: '#ffffff', color: '#3b82f6', textDecoration: 'none', border: '1px solid #e2e8f0' }}>System: Customer Account Mgmt</a>
